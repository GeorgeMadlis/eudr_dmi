...
## Boundary
This repo does not describe how `geospatial_dmi` works internally. The “Produced By” column references agents/workflows and canonical entrypoints only.
...
- Each evidence artifact MUST be defined in [20_evidence_bundle_spec.md](20_evidence_bundle_spec.md).
- TODO: Add canonical references/links to the upstream `geospatial_dmi` entrypoints used (without describing architecture).
