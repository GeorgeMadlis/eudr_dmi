...
| Field | Type | Required | Notes |
|---|---:|---:|---|
| `decisions` | array | yes | Records invoked uncertainty/conflict decisions with references to [docs/architecture/method_notes_and_decisions.md](method_notes_and_decisions.md). |
