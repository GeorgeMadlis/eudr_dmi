...
## Purpose
This contract defines the minimum obligations for any generator or workflow that produces evidence bundles for this project, and the minimum expectations for inspection. It is project-level and does not describe upstream platform internals (including `geospatial_dmi`).
...
|---|---|---|---|
| Completeness | All required files exist per bundle spec. | [docs/architecture/evidence_bundle_spec.md](evidence_bundle_spec.md) | Required artifacts present; no missing required directories/files. |
...
- [docs/architecture/evidence_bundle_spec.md](evidence_bundle_spec.md) to include article-specific artifacts.
- [docs/regulation/policy_to_evidence_spine.md](../regulation/policy_to_evidence_spine.md) to map obligations → these artifacts with acceptance criteria.
