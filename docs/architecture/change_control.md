...
- Update the spine: [docs/regulation/policy_to_evidence_spine.md](../regulation/policy_to_evidence_spine.md)
  - Add/modify rows for impacted obligations, objectives, artifacts, and acceptance criteria.
- Update method notes: [docs/architecture/method_notes_and_decisions.md](method_notes_and_decisions.md)
  - Add a decision log entry for method or policy changes.
- Update evidence spec: [docs/architecture/evidence_bundle_spec.md](evidence_bundle_spec.md)
  - If artifacts or verification rules change.
- Update risk register: [docs/architecture/risk_register.md](risk_register.md)
