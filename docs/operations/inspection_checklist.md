...
Optional (recommended): run the bundle validator to check required files + `manifest.sha256`:
...
2. For each dependency listed, confirm required provenance fields per [docs/architecture/dependency_register.md](../architecture/dependency_register.md).
...
3. Cross-check control objectives and acceptance criteria in [docs/regulation/policy_to_evidence_spine.md](../regulation/policy_to_evidence_spine.md).
...
- Re-run with identical inputs and pinned dependencies (see [docs/operations/runbooks.md](runbooks.md)).
